...
//import hudson.model.GlobalConfiguration;
...
public class GearmanPluginConfig implements Describable<GearmanPluginConfig>, Serializable {
    ...
    @Override
    public GearmanPluginConfigDescriptor getDescriptor() {
        return (GearmanPluginConfigDescriptor) Hudson.getInstance().getDescriptorOrDie(getClass());
    }

    boolean enablePlugin() {
        return getDescriptor().enablePlugin();
    }
    ...
    public static class GearmanPluginConfigDescriptor<T extends GearmanPluginConfig> extends Descriptor<GearmanPluginConfig> {
         ...
         * Constructor.
         */
        public GearmanPluginConfigDescriptor() {
            load();
        }
